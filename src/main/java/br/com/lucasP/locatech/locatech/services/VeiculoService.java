...
import br.com.lucasP.locatech.locatech.repositories.VeiculoRepository;
...
public class VeiculoService {
    ...
    public void saveVeiculo(Veiculo veiculo){
        ...
        Assert.state(save == 1, "Ocorreu um erro ao salvar o veiculo " + veiculo.getModelo());
    }

    public void updateVeiculo(Veiculo veiculo, Long id){
        var update = this.veiculoRepository.update(veiculo, id);
        if (update == 0) {
            throw new RuntimeException("Ocorreu um erro ao atualizar o veiculo " + veiculo.getModelo());
        }
    }
    ...
    public void deleteVeiculo(Long id){
        ...
        if (delete == 0) {
            throw new RuntimeException("Ocorreu um erro ao deletar o veiculo com id " + id);
        }
    }
}
